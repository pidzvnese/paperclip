...
export function CompanySettings() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      ...
      { label: t("companySettings.breadcrumbSettings") }
    ]);
    ...
    <div className="max-w-2xl space-y-6">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    placeholder={t("companySettings.brandColorPlaceholder")}
      ...
      {generalDirty && (
        <div className="flex items-center gap-2">
          ...
          >
            {generalMutation.isPending ? t("common.saving") : t("companySettings.saveChanges")}
          </Button>
        ...
        <div className="space-y-3 rounded-md border border-border px-4 py-4">
          <div className="flex items-center gap-1.5">
            <span className="text-xs text-muted-foreground">
              {t("companySettings.openClawInviteDesc")}
            </span>
            <HintIcon text={t("companySettings.openClawInviteHint")} />
          </div>
          <div className="flex flex-wrap items-center gap-2">
            ...
            >
              {inviteMutation.isPending
                ...
                : t("companySettings.generatePrompt")}
            </Button>
          </div>
          {inviteError && (
