...
export function Companies() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("pages.companies") }]);
  }, [setBreadcrumbs, t]);
            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-5 mt-4 text-sm text-muted-foreground flex-wrap">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    {t("companies.agent_count", { count: agentCount })}
                  </span>
                </div>
                <div className="flex items-center gap-1.5">
                  <CircleDot className="h-3.5 w-3.5" />
                  <span>
                    {t("companies.issue_count", { count: issueCount })}
                  </span>
                </div>
                ...
                <div className="flex items-center gap-1.5 ml-auto">
                  ...
                  <span>{t("companies.createdAgo", { time: relativeTime(company.createdAt) })}</span>
                </div>
              </div>
