    ...
    if (companies.length === 0) {
      return (
        <EmptyState
          ...
          message={t("dashboard.welcomeNoCompany")}
          action={t("common.getStarted")}
          onAction={openOnboarding}
        />
      );
    }
    return (
      <EmptyState icon={LayoutDashboard} message={t("dashboard.selectCompanyToView")} />
    );
  }
              ...
              description={
                <span>
                  {data.costs.monthBudgetCents > 0
                    ? `${data.costs.monthUtilizationPercent}% of ${formatCents(data.costs.monthBudgetCents)} ${t("dashboard.last14Days")}`
