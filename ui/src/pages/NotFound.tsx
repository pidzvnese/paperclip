...
export function NotFoundPage({ scope = "global", requestedPrefix }: NotFoundPageProps) {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("pages.notFound") }]);
  }, [setBreadcrumbs, t]);
  ...
  const title = scope === "invalid_company_prefix" ? t("pages.companyNotFound") : t("pages.pageNotFound");
  const description =
    scope === "invalid_company_prefix"
      ? t("notFound.companyPrefixDesc", { prefix: normalizedPrefix ?? "unknown" })
      : t("pages.routeNotExist");
