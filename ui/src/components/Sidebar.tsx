      ...
      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide flex flex-col gap-4 px-3 py-2">
        <div className="flex flex-col gap-0.5">
          ...
          >
            ...
            <span className="truncate">{t("terms.newTask")}</span>
          </button>
        ...
        <SidebarSection label={t("sidebar.work")}>
          <SidebarNavItem to="/startup-builder" label={t("sidebar.startupBuilder")} icon={Rocket} />
          <SidebarNavItem to="/issues" label={t("terms.issues")} icon={CircleDot} />
        ...
        <SidebarSection label={t("terms.workspace")}>
